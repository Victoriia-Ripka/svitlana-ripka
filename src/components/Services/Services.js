...
const Services = () => {
  const [activeType, setActiveType] = useState([
    {
      type: 'Індивідуально',
      text1:
        'Консультування з проблем особистих і сімейних відносин, професійного зростання та індивідуального розвитку.',
      text2:
  ...
  return (
    <Container>
      <ServicesContainer>
        <Title>
          Допомагаю дітям, підліткам, дорослим, батькам з дітьми, сімейним
          парам, партнерам:
        </Title>
        <NavigationDiv>
          <NavList>
